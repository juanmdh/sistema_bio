        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseregistrar" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Tipo de búsqueda:</h6>
                        <a class="collapse-item" href="registrar_paciente.php">Paciente</a>
                        <a class="collapse-item" href="../medico/registrar_medico.php">Médico</a>
                        <a class="collapse-item" href="../trabajador/registrar_trabajador.php">Trabajador</a>
                    </div>
                </div>
            </li>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class=" row col-10">
                            <div class="col-12 " id="card_buscar_paciente" name="card_buscar_paciente" >                            
                                <div class="card shadow mb-4">
                                    <!-- Card Header - Accordion -->
                                    <a href="#collapseCarBuscarPaciente" class="d-block card-header py-3" data-toggle="collapse"
                                        role="button" aria-expanded="true" aria-controls="collapseCarBuscarPaciente">
                                                <h6 class="m-0 font-weight-bold text-primary">Buscar paciente</h6>
                                    </a>                                    
                                    <!-- Card Content - Collapse -->
                                    <div class="collapse gravity-center show " id="collapseCarBuscarPaciente">
                                        <div class="col-12 card-body">
                                            <form id="formulario_buscar_pacientes"  method="POST" class="needs-validation row col-12" novalidate>
                                                <div class="row col-12"> 
                                                    <div class="col-4 mt-2">
                                                        <label class="form-label m-0 font-weight-bold text-primary">Ingrese el número de DNI:</label>
                                                        <label class="form-label m-0 font-weight-bold text-danger">*</label>      
                                                    </div>
                                                    <div class="col-4">
                                                        <input type="text" name="dni_fb" class="col-12 form-control" id="dni_fb" required>
                                                    </div>     
                                                    <div class="col-4">
                                                        <button id="boton_buscar" name="boton_buscar" type="submit" class="col-5 btn btn-warning" 
                            ...
                            <div id="card_datos_paciente" name="card_datos_paciente" class="col-12" style="display: none">                            
                                <div class="card shadow mb-4">
                                    <!-- Card Header - Accordion -->
                                    <a href="#collapseCarRegistroPaciente" class="d-block card-header py-3" data-toggle="collapse"
                                        role="button" aria-expanded="true" aria-controls="collapseCarRegistroPaciente">
                                                <h6 class="m-0 font-weight-bold text-primary">Ingrese todos los siguientes datos</h6>                                                                            
                                    </a>                                    
                                    <!-- Card Content - Collapse -->
                                    <div class="collapse gravity-center show " id="collapseCarRegistroPaciente">
                                        <div class="row col-12 card-body">
                                            <form id="formulario_registro_pacientes"  method="POST" class="needs-validation row col-12" novalidate>
                                                <div class="row col-12"> 
                                                    <div class="col-3 mt-2">
                                                        <label class="form-label m-0 font-weight-bold text-primary">DNI:</label>
                                                        <label class="form-label m-0 font-weight-bold text-danger">*</label>      
                                                    </div>
                                                    <div class="col-4">
                                                        <input type="text" name="dni_f" class="col-12 form-control" id="dni_f" required>
                                                    </div>                                                  
                                                </div>
                                                <div class="row col-12 mt-4"> 
                                                    <div class="col-3 mt-2">
                                                        <label class="form-label m-0 font-weight-bold text-primary">Nombres y apellidos:</label>
                                                        <label class="form-label m-0 font-weight-bold text-danger">*</label>      
                                                    </div>
                                                    <div class="col-9">
                                                        <input type="text" name="nombres" class="col-12 form-control" id="nombres" required>
                                                    </div>                                                  
                                                </div>
                                                <div class="row col-12 mt-4"> 
                                                    <div class="col-3 mt-2">
                                                        <label class="form-label m-0 font-weight-bold text-primary">Telefono:</label>
                                                        <label class="form-label m-0 font-weight-bold text-danger">*</label>      
                                                    </div>
                                                    <div class="col-4">
                                                        <input type="text" name="telefono" class="col-12 form-control" id="telefono" required>
                                                    </div>                                                  
                                                </div>                                                
                                                <div class="row col-12 mt-4"> 
                                                    <div class="col-3 mt-2">
                                                        <label class="form-label m-0 font-weight-bold text-primary">Fecha de nacimineto:</label>
                                                        <label class="form-label m-0 font-weight-bold text-danger">*</label>      
                                                    </div>
                                                    <div class="col-3">
                                                        <input type="date" name="fecha_nacimiento" class="col-12 form-control" id="fecha_nacimiento" required>
                                                    </div>                                                  
                                                </div>
                                                <div class=" row col-12 mt-4"> 
                                                    <div class="col-3 mt-2">
                                                        <label class="form-label m-0 font-weight-bold text-primary">Sexo:</label>
                                                        <label class="form-label m-0 font-weight-bold text-danger">*</label>      
                                                    </div>
                                                    <div class="col-4">                                                        
                                                        <select id="sexo" name="sexo" class="form-select form-control form-select-lg mb-3" aria-label=".form-select-lg example">
                                                            <option selected value="-1">--Seleccione el sexo--</option>
                                                ...
                                                <div class=" row col-12">                                                             
                                                    ...
                                                    <div class="col-4 mt-5">
                                                        <button id="boton_guardar" name="boton_guardar" type="submit" class="col-12 btn btn-success" 
