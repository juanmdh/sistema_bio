...
<body id="page-top">
                            ...
                            <div class="col-12">                            
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="collapse gravity-center show " id="collapseCarNombres">
                                        <div class="row col-12 card-body">
                                            <form id="formulario_nombres"  method="POST" class="needs-validation row col-12" novalidate>
                                                ...
                                                <button id="botonmodificar_nombres" name="botonmodificar_nombres" type="submit" class="btn btn-primary" 
                                ...
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="collapse gravity-center show " id="collapseCarDni">
                                        <div class="row col-12 card-body">
                                            <form id="formulario_dni"  method="POST" class="needs-validation row col-12" novalidate>
                                                <div class="col-4 mt-2">
                                                    <strong>
                                                        <?php
                                                            echo $valores['dni'];
                                                ...
                                                <div class=" col-5"> 
                                                        <input type="number" name="dni_f" class="col-12 form-control" id="dni_f" required>
                                                </div>
                                                <div class=" col-3">                                                   
                                ...
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="collapse gravity-center show " id="collapseCarTelefono">
                                        <div class="row col-12 card-body">
                                            <form id="formulario_telefono"  method="POST" class="needs-validation row col-12" novalidate>
                                                <div class="col-4 mt-2">
                                                    <strong>
                                                        <?php
                                                ...
                                                <div class=" col-3">                                                   
                                                        ...
                                                        <button id="botonmodificar_telefono" name="botonmodificar_telefono" type="submit" class="btn btn-primary" 
                                                        value="Modificar">Modificar</button>
                                                </div>
                                            </form> 
                                        </div>
                                ...
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="collapse gravity-center show " id="collapseCarDireccion">
                                        <div class="row col-12 card-body">
                                            <form id="formulario_direccion"  method="POST" class="needs-validation row col-12" novalidate>      
                                                <div class="col-4 mt-2">
                                                    <strong>
                                                        <?php
                                                ...
                                                <div class=" col-5"> 
                                                        <input type="text" name="direccion" class="col-12 form-control" id="direccion" required>                                                
                                                </div>
                                                <div class=" col-3">                                                   
                                                        <!-- <input name="botonmodificar" type="submit" class="btn btn-primary" value="Modificar"> -->
                                                        <button id="botonmodificar_direccion" name="botonmodificar_direccion" type="submit" class="btn btn-primary" 
                                                        value="Modificar">Modificar</button>
                                                </div>
                                            </form>
                                        </div>
    ...
    <script>
        $(document).ready(function(){
            $("#botonmodificar_direccion").on('click',function(e){ 
                e.preventDefault();
                modificar_direccion();
            });
        })
